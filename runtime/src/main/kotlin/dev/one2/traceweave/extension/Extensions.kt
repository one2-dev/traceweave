...
internal fun Throwable.wasCopied(): Boolean = stackTrace.any { it.className == Copy.MARKER }

// True for frames that belong to the coroutine machinery rather than user code.
internal fun StackTraceElement.isCoroutineMachinery(): Boolean =
...
internal fun Throwable.withCause(cause: Throwable): Throwable = apply { initCause(cause) }
